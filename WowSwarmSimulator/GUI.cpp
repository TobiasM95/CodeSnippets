...
int WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nShowCmd)
{
    ...
    io.Fonts->AddFontFromMemoryCompressedTTF(Fonts::Roboto_Medium_compressed_data, Fonts::Roboto_Medium_compressed_size, 13.0f);
    io.Fonts->AddFontFromMemoryCompressedTTF(Fonts::Roboto_Medium_compressed_data, Fonts::Roboto_Medium_compressed_size, 40.0f);

    //io.IniFilename = cwd.string().c_str();
    ...
    while (!done)
    {
        ...
        {
            if (msg.message == WM_SAVEBEFOREDESTROY) {
